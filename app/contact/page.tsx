      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <Card className="pixel-card text-center">
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">{settings?.contactEmail || "Loading..."}</p>
          ...
          <Card className="pixel-card text-center">
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">{settings?.contactPhone || "Loading..."}</p>
          ...
          <Card className="pixel-card text-center">
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">+{settings?.contactWhatsapp || "Loading..."}</p>
              <Button asChild variant="outline" className="pixel-button bg-transparent">
